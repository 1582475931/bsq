    ...
    <ul class="cont">
      <li v-for="item in data" :key="item.id">
        <div class="box1">
          ...
          <div class="right">
            <p class="p1">
              ￥{{Number(item.price)*Number(item.quantity)}}<span>.00</span>
            </p>
            <p class="p2">
              X
        ...
        <div class="footer">
          ...
          <!-- <router-link to="/pingjia?id=''" class="p1" v-if="item.isA==0">评价</router-link> -->
          <p class="p1" v-if="item.isA==0" @click="$router.push('/pingjia?id='+item.waresId)">评价</p>
          <p class="p1" v-else>已评价</p>
